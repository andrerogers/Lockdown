...
cl /Fe"remderer" -I ..\src\includes %CommonCompilerFlags% -D_CRT_SECURE_NO_WARNINGS ..\src\renderer\*.c ..\src\renderer\*.cpp %CommonDependencies% /link /LIBPATH:"..\\src\\libs" %CommonLinkerFlags%
